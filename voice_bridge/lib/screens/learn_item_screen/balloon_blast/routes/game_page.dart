...
class GamePage extends Component with DragCallbacks, HasGameReference<BalloonBlastGame> {
    ...
    if(!_countdownFinished){
    ...
    else
      {
        ...
        fruitsTime.where((element) => element < time )
            ...
            add(RectangleTest(fruitPosition, pageSize: gameSize, velocity: velocity));
